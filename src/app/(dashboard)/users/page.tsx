        ...
        <div className="mb-4 flex items-center gap-3">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full pl-9 pr-3.5 py-2 text-sm bg-white border border-slate-200 rounded-xl shadow-sm
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200">
                    ...
                    <th className="text-left py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wide">Username</th>
                    <th className="text-left py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wide hidden sm:table-cell">Profile</th>
                    <th className="text-left py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wide hidden md:table-cell">Time Limit</th>
                    <th className="text-left py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wide hidden md:table-cell">Uptime</th>
                    <th className="text-left py-3 px-4 text-xs font-semibold text-slate-500 uppercase tracking-wide hidden lg:table-cell">Note</th>
                ...
                <tbody>
                  {paged.map((u, i) => (
                    ...
                    >
                      <td className="py-2.5 px-4 text-slate-400 tabular-nums text-xs">
                      ...
                      <td className="py-2.5 px-4 text-slate-500 text-xs hidden md:table-cell tabular-nums">
                        {u.limitUptime || <span className="text-slate-300">—</span>}
                      </td>
                      <td className="py-2.5 px-4 text-slate-500 text-xs hidden md:table-cell tabular-nums">
                        {u.uptime || <span className="text-slate-300">—</span>}
                      </td>
                      <td className="py-2.5 px-4 text-slate-400 text-xs hidden lg:table-cell">
